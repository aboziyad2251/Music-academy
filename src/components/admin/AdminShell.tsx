...
export default function AdminShell({ user, children }: AdminShellProps) {
  ...
  const SidebarInner = ({ onLinkClick }: { onLinkClick?: () => void }) => (
    <div className="flex flex-col h-full">
      ...
      <div className="px-3 pb-5 pt-3 border-t border-slate-800 space-y-3 flex-shrink-0">
        {/* Platform Status */}
        <div className="px-3 py-2 rounded-lg bg-slate-950/50 border border-slate-800">
        ...
        <header className="h-16 bg-slate-900 border-b border-slate-800 flex items-center justify-between px-4 md:px-6 flex-shrink-0 z-10">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden sm:flex flex-col items-end leading-none gap-1">
              ...
              <Badge className="bg-amber-600 hover:bg-amber-700 text-white text-[10px] h-4 px-1.5 rounded-sm">
                ADMIN
              </Badge>
            </div>
